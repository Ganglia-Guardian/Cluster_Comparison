...
- [Arena pipelines not frame-aligned](arena-pipelines-not-frame-aligned.md) — arena data layout (flat, MATLAB-only), the 5 mice (3 MitoPark + 2 control), and the Folder_Name suffix gotcha
